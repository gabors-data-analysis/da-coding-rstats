...
1. Use spacing as you learn R. It will make your code much more readable. E.g. as we will see functions use parenthesis `()`, indexing brackets `[]`, conditionals and loops curly brackets `{}`. It is a good practice to use a space after opening and before closing a parenthesis/brackets. Furthermore, after an input we use a comma directly and after that use a space before the next input or the closing bracket, but not double spacing: before and after the comma.
