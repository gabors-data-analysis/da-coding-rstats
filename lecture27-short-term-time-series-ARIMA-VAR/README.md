# Lecture 27: Forecasting from Time Series Data II - ARIMA and VAR models
...
## Learning outcomes
After successfully completing [`short_term_priceindex.R`](https://github.com/gabors-data-analysis/da-coding-rstats/blob/main/lecture27-short-term-time-series-ARIMA-VAR/short_term_priceindex.R), students should be able:
